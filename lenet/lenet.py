...
from mindspore import context, Model, load_checkpoint, load_param_into_net, SummaryCollector
...
def train_net(network_model, epoch_size, data_path, repeat_size, ckpoint_cb, summary_collector,sink_mode):
    """Define the training method."""
    print("============== Starting Training ==============")
    # load training dataset
    ds_train = create_dataset(os.path.join(data_path, "train"), 32, repeat_size)
    network_model.train(epoch_size, ds_train, callbacks=[ckpoint_cb, LossMonitor(),summary_collector], dataset_sink_mode=sink_mode)
...
if __name__ == "__main__":
    ...
    train_net(model, train_epoch, mnist_path, dataset_size, ckpoint,summary_collector, dataset_sink_mode)
